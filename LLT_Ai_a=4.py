...
df = pd.read_csv(".\CFD\\3D\\3Dwindtunnelmodel_a=4.00_v=49.00ms_induced_angle.csv", skipinitialspace=True, delimiter=';')
...
plt.show()
print(df)
plt.savefig('.\CFD\\3D\graphs\\'+str(['induced_angle-alpha=4'])+'.svg',dpi=1200)
plt.clf()
